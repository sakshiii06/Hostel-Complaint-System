      ...
      <section class="bg-gray-100 py-12 text-gray-800 sm:py-24 h-full">
        <div class="bg-gray-100 mx-auto flex max-w-md flex-col rounded-lg lg:max-w-screen-xl lg:flex-row">
          <div class="max-w-2xl px-4 lg:pr-24">
            <p class="mb-2 text-blue-600">Hostel Complaint System</p>
            <h3 class="mb-5 text-3xl font-semibold ">Submit Your Complaint</h3>
            <p class="mb-16 text-md text-gray-600">
         <h2 class="text-2xl font-bold text-green-800 mb-4">Welcome to the Hostel Complaint System</h2>
         
At our Hostel Complaint System, we prioritize the swift and confidential resolution of all student concerns. We ensure that every submitted complaint receives prompt attention, fostering a safe and comfortable living environment for all our hostel residents. Your satisfaction and peace of mind are our top priorities.
            </p>
          ...
          <div class="border border-gray-100 shadow-gray-500/20 mt-8 mb-8 max-w-md bg-white shadow-sm sm:rounded-lg sm:shadow-lg lg:mt-0">
            <div class="relative border-b border-gray-300 p-4 py-8 sm:px-8">
              <h3 class="mb-1 inline-block text-3xl font-medium">
                <span class="mr-4 text-green-800">Submit Complaint</span>
